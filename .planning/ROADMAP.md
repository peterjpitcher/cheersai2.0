...
- [x] 05-02-PLAN.md — Email notification routing: shared helpers, extend crons for token expiry and disconnection emails
...
- [x] 06-02-PLAN.md — Link-in-bio schema reconciliation, extended types, click tracking, templates, auto-save
