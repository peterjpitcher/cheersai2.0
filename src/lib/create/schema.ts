...
export const instantPostSchema = z.object({
...
export const instantPostFormSchema = z.object({
  title: z.string().min(1, "Title is required"),
  prompt: z.string().min(1, "Tell us what to post"),
  publishMode: z.enum(["now", "schedule"]),
...
export const eventCampaignSchema = eventBaseSchema.extend({
  scheduleOffsets: z
    .array(
      z.object({
        label: z.string(),
...
export const eventCampaignFormSchema = z.object({
  name: z.string().min(1, "Event name is required"),
  description: z.string().min(1, "Give us some detail"),
...
export const promotionCampaignFormSchema = z.object({
  name: z.string().min(1, "Promotion name is required"),
  offerSummary: z.string().min(1, "Tell guests what the offer is"),
  startDate: z.string().min(1, "Start date required"),
...
export const weeklyCampaignSchema = z.object({
...
export const weeklyCampaignFormSchema = z.object({
  name: z.string().min(1, "Campaign name is required"),
  description: z.string().min(1, "Give us some detail"),
