      ...
      >
        ...
        <div className="space-y-4">
          ...
          {sport === 'rugby_union' && <fieldset className="space-y-3 border p-3" style={{ borderColor: 'var(--c-line)' }}>
            ...
            <p className="text-sm">Opening and kitchen times remain unchanged. Earlier games show from opening with the start missed. Check each game for any conditional late-finish arrangement. Kitchen service does not extend.</p>
