      ...
      <main>
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">1. Acceptance of Terms</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">2. Description of Service</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">3. Account Registration</h2>
            
            <h3 className="mb-3 text-lg font-semibold">3.1 Account Creation</h3>
            <p className="mb-4">
            ...
            <h3 className="mb-3 text-lg font-semibold">3.2 Account Requirements</h3>
            <ul className="mb-4 list-disc pl-6">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">4. Subscriptions and Billing</h2>
            
            <h3 className="mb-3 text-lg font-semibold">4.1 Free Trial</h3>
            <p className="mb-4">
            ...
            <h3 className="mb-3 text-lg font-semibold">4.2 Subscription Plans</h3>
            <div className="mb-4 rounded-medium bg-gray-50 p-4">
            ...
            <h3 className="mb-3 text-lg font-semibold">4.3 Payment Terms</h3>
            <ul className="mb-4 list-disc pl-6">
            ...
            <h3 className="mb-3 text-lg font-semibold">4.4 Automatic Renewal</h3>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">5. Cancellation and Refunds</h2>
            
            <h3 className="mb-3 text-lg font-semibold">5.1 Cancellation</h3>
            <ul className="mb-4 list-disc pl-6">
            ...
            <h3 className="mb-3 text-lg font-semibold">5.2 Refund Policy</h3>
            <ul className="mb-4 list-disc pl-6">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">6. User Content and Conduct</h2>
            
            <h3 className="mb-3 text-lg font-semibold">6.1 Your Content</h3>
            <p className="mb-4">
            ...
            <h3 className="mb-3 text-lg font-semibold">6.2 Prohibited Uses</h3>
            ...
            <h3 className="mb-3 text-lg font-semibold">6.3 Content Standards</h3>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">7. Intellectual Property</h2>
            
            <h3 className="mb-3 text-lg font-semibold">7.1 Our Property</h3>
            <p className="mb-4">
            ...
            <h3 className="mb-3 text-lg font-semibold">7.2 Feedback</h3>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">8. Third-Party Services</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">9. Disclaimers and Limitations</h2>
            
            <h3 className="mb-3 text-lg font-semibold">9.1 Service Availability</h3>
            <p className="mb-4">
            ...
            <h3 className="mb-3 text-lg font-semibold">9.2 Limitation of Liability</h3>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">10. Indemnification</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">11. Termination</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">12. Governing Law</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">13. Changes to Terms</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">14. Severability</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">15. Entire Agreement</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">16. Contact Information</h2>
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-heading text-xl font-bold">17. Specific Platform Terms</h2>
            
            <h3 className="mb-3 text-lg font-semibold">17.1 Facebook and Instagram</h3>
            <p className="mb-4">
            ...
            <h3 className="mb-3 text-lg font-semibold">17.2 AI-Generated Content</h3>
            <p className="mb-4">
